...
# function to perform Games-Howel post-hoc test which does not assume equal variances and sample sizes
# see: https://rpubs.com/aaronsc32/games-howell-test
# src:https://stats.stackexchange.com/questions/83941/games-howell-post-hoc-test-in-r
# 
...
posthocTGH <- function(y, x, method=c("games-howell", "tukey"),
  ...
  columnNames <- c('mean diff.', 'conf.int.lower', 'conf.int.upper', 't statistic', 'Df', 'p-value');
  if (p.adjust != "none") {
